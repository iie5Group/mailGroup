...
public:
	...
	~ProgressBar_Base(void)
	{
        gtk_widget_destroy(m_ptrProgressBarWindow);
    }

private:
	GtkWidget            *m_ptrProgressBarWindow;
...
public:
	void CreateProgressBar()
	{
        ...
        //设置进度条控制范围
		m_ptrAdjustment = (GtkAdjustment*)gtk_adjustment_new(0, 0, 1, 0, 0, 0);
...
public:
                                             ...
                                             double     upload_now)
	{
        ...
        if(1 <= download_now/download_total)
        {
            testDownloadLog<< "Done!" <<endl;
            gtk_main_quit();
        }
        gdk_threads_leave();
        return 0;
